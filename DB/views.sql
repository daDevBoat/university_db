...
SELECT 
    l.course_code,
    i.instance_id,
    l.hp * exam_calc.hp_factor + i.num_students * exam_calc.students_factor + exam_calc.constant AS exam_hours,
    l.hp * admin_calc.hp_factor + i.num_students * admin_calc.students_factor + admin_calc.constant AS admin_hours
